...
function Manager_ExportSession(name, save_to_file, save_to_manager, save_to_autosave_manager) {
    if (opt.debug) Utils_log("manager.js: Manager_ExportSession: name = " + name + ": save_to_file = " + save_to_file + ": save_to_manager = " + save_to_manager + ": save_to_autosave_manager = " + save_to_autosave_manager);
